...
export function ServicesMenu() {
  if (!servicesMenu?.items) {
    return null;
  }

  const regularItems = servicesMenu.items.filter(
    (item) => !item.featured
  );

  const featuredItem = servicesMenu.items.find(
    (item) => item.featured
  );
        ...
        >
          ...
          <div className="mb-5 flex items-end justify-between">
            ...
            <span className="hidden text-xs text-muted sm:block">
              Strategies built for measurable growth
            </span>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted">
                    Discover everything The Media Buddy can do.
                  </p>
                </div>
              </div>
