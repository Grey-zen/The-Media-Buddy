...
const workMenu = navigation.find(
  (item) => item.label === "Our Work"
);
...
export function WorkMenu() {
  ...
  const regularItems = workMenu.items.filter(
    (item) => !item.featured
  );

  const featuredItem = workMenu.items.find(
    (item) => item.featured
  );
  ...
  const iconMap = {
    ...
    "Client Results": Target,
    "Project Videos": PlayCircle,
  };
      ...
      >
        ...
        >
          ...
          {featuredItem &&
            (() => {
              const FeaturedIcon =
                featuredItem.icon ?? BriefcaseBusiness;

              return (
                <Link
                  href={featuredItem.href ?? "/work"}
                  className="
                    group/cta
                    mt-4
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted">
                        Explore projects, case studies and campaign results.
                      </p>
                    </div>
                  </div>
